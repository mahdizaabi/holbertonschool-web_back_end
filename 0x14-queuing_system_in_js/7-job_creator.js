...
const createAndEnqueueJob = (jobData) => {
    ...
    job.on('failed', (error) => console.log(`Notification job JOB_ID failed: ${error}`));
    job.on('progress', (progress, data) => console.log(`Notification job JOB_ID ${progress} complete`));
}
